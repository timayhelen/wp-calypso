...
const CancelPurchaseSurvey = React.createClass( {
	propTypes: {
	...
	handleRadioOne( event ) {
		...
		newState.questionOneRadio = event.currentTarget.value;
		newState.questionOneText = '';
	...
	handleTextOne( event ) {
		const newState = this.state;
		newState.questionOneText = event.currentTarget.value;
		this.setState( newState );
		this.props.callbackParent( newState );
	},
	...
	handleRadioTwo( event ) {
		const newState = this.state;
		newState.questionTwoRadio = event.currentTarget.value;
		newState.questionTwoText = '';
		this.setState( newState );
		this.props.callbackParent( newState );
	},
	...
	handleTextTwo( event ) {
		const newState = this.state;
		newState.questionTwoText = event.currentTarget.value;
		this.setState( newState );
		this.props.callbackParent( newState );
	},
	...
	handleTextThree( event ) {
		const newState = this.state;
		newState.questionThreeText = event.currentTarget.value;
		this.setState( newState );
		this.props.callbackParent( newState );
	},
	...
	renderQuestionOne() {
		...
		const couldNotInstallInput = (
			<FormTextInput
				className="cancel-purchase-survey__reason-input"
...
export default CancelPurchaseSurvey;
